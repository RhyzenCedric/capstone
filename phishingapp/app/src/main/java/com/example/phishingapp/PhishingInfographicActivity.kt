...
class PhishingInfographicActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_phishinginfo_section)
    ...
    private fun fetchRandomInfographics() {
        ...
        val url = "https://capstone-server-p18f.onrender.com/infographics?type=phishing"
